...
<body>
    ...
    <form method="post" action="">
        <table>
            ...
            <tr>
                <td>Abs</td>
                <td><input type="radio" name="abs" value="tak" <?= ($wiersz['abs'] ?? '') == 'tak' ? 'checked' : '' ?> /> <label>tak</label></td>
                <td><input type="radio" name="abs" value="nie" <?= ($wiersz['abs'] ?? '') == 'nie' ? 'checked' : '' ?> /> <label>nie</label></td>
            </tr>
            <tr>
                <td>Esp</td>
                <td><input type="radio" name="esp" value="tak" <?= ($wiersz['esp'] ?? '') == 'tak' ? 'checked' : '' ?> /> <label>tak</label></td>
                <td><input type="radio" name="esp" value="nie" <?= ($wiersz['esp'] ?? '') == 'nie' ? 'checked' : '' ?> /> <label>nie</label></td>
            </tr>
            <tr>
